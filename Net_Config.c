...
#define CONFIG_EXAMPLE_PROV_TRANSPORT_BLE 0
#define CONFIG_EXAMPLE_PROV_TRANSPORT_SOFTAP 0

#define CONFIG_EXAMPLE_PROV_SECURITY_VERSION_1 0
...
#define CONFIG_EXAMPLE_RESET_PROV_MGR_ON_FAILURE 0
